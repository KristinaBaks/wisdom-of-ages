...
var loveButton = document.querySelector('.button__1');
var careerButton = document.querySelector('.button__2');
var lifeButton = document.querySelector('.button__3');
var whateverButton = document.querySelector('.button__4');
var mainBox = document.querySelector('.main-box');
var heading_1 = document.querySelector('.heading-primary__1');
var heading_2 = document.querySelector('.heading-primary__2');
var paragraph_1 = document.querySelector('.paragraph__1');
var paragraph_2 = document.querySelector('.paragraph__2'); //------------
